...
public:
     ...
     */
    Register(int number, const folly::fbstring &name, const ir::MemoryLocation &memoryLocation):
        number_(number),
        lowercaseName_(name),
        uppercaseName_(name),
     ...
     */
    const folly::fbstring &lowercaseName() const { return lowercaseName_; }

    /**
     * \return                         Register uppercase name.
     */
    const folly::fbstring &uppercaseName() const { return uppercaseName_; }
...
private:
    ...
    folly::fbstring lowercaseName_; ///< Lowercase register name.
    folly::fbstring uppercaseName_; ///< Uppercase register name.
